...
import colors from "../assets/colors.js";
  const ProductInfo = ({ route, navigation }) => {
    ...
    const addToCart =async ()=>{
      ...
      if(selectedSize != -1){
        const item = {productID : productID , quantity : 1, size : Object.keys(product.size)[selectedSize]}
        try{
                        ...
                        >
                          <Text
                            style={{
                              width: 50,
                              height: 50,
                              textDecorationLine:product.size[Object.keys(product.size)[index]] == 0 ?  'line-through' : 'none',
                              backgroundColor: product.size[Object.keys(product.size)[index]] == 0 ? colors.ligthGray: "#e5eddf",
                              borderRadius: 10,
                              textAlign: "center",
                              lineHeight: 50,
                              fontWeight: "bold",
                              borderWidth: index == selectedSize ? 3 : 0,
                              color : product.size[Object.keys(product.size)[index]] == 0 ? colors.gray:colors.black
                            }}
                          >
                            {item}
                          </Text>
