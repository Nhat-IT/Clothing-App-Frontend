...
const Cart = ({navigation})=>{
    ...
    return(
        <View style={{backgroundColor : '#ffffff',flex : 1}}>
            {items.length < 1 ? <View style={styles.emptyCart}>
            <UNIQLO  fill={colors.red} />
                <Text style={{fontFamily: 'SFB',fontSize : 20 ,marginVertical : 50}}>Your cart is empty</Text>
                <Text style={{fontFamily: 'SFM',fontSize : 10,marginBottom : 5}}>Check out our</Text>
